            ...
            animate: function(e) {
                e.forEach(function(e) {
                    ...
                    if (t = e.getAttribute("data-sr-id")) {
                        if (i = o.data[t], i.css || (i.css = o.createStyles(e, i)), e.getAttribute("data-sr-initialized") || (e.setAttribute("style", i.style + i.css.initial), e.setAttribute("data-sr-initialized", !0)), !o.isElementInViewport(e, o.config.viewportFactor))
                            return void (i.reset && e.setAttribute("style", i.style + i.css.initial + i.css.reset));
                        if (e.getAttribute("data-sr-complete"))
                            return;
                        if (o.isElementInViewport(e, o.config.viewportFactor))
                            return e.setAttribute("style", i.style + i.css.target + i.css.transition), void (i.reset || setTimeout(function() {
